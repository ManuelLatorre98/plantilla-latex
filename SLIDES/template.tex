...
%----------------------------------------------------------------------------------------
% to use a draw.io image, export it on .png with te following params: 150% zoom & in a rectangle with 1.5/1 proportions
...
\title{Redes de Computadoras: \\ Ejercicio de sub-redes}

\subtitle{Capa de Red}

\author{Manuel Latorre \\ Otro}

% \titlegraphic{\includegraphics[scale=1.25]{Images/focuslogo.pdf}} % Optional title page image, comment this line to remove it

\institute{Facultad de Informática \\Universidad Nacional del Comahue}
...
\section{Ejercicio de ejemplo} % Section title slide, unnumbered

%------------------------------------------------

\begin{frame}{Enunciado}
	La red que se encuentra asignada a la dirección \textbf{192.10.10.0} cuenta con las siguientes subredes:
	\begin{itemize}
	    \item 4 redes de 30 hosts
	    \item 1 red de 100 hosts
	\end{itemize}
	\pause
	Debe responder:
    \begin{enumerate}
        \item ¿De que tipo/clase es la red?
        \item ¿Por defecto, cuál es su máscara de subred?
        \item ¿Cuántos bits son necesarios para la red?
        \item ¿Cuántos bits son necesarios para el host?
        \item Para cada subred indique:
        \begin{itemize}
            \item Dirección.
            \item Máscara.
            \item Dirección de broadcast.
        \end{itemize}
    \end{enumerate}
\end{frame}
